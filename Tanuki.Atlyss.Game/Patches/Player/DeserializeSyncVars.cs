...
public static class DeserializeSyncVars
{
    ...
    public delegate void Before(global::Player Player, NetworkReader NetworkReader, bool InitialState, ref bool ShouldAllow);
    public static event Before OnBefore;

    public delegate void After(global::Player Player, NetworkReader NetworkReader, bool InitialState, bool Cancelled);
    public static event After OnAfter;

#pragma warning disable IDE0051
    private static bool Prefix(global::Player __instance, NetworkReader reader, bool initialState, out State __state)
    {
    ...
    private static void Postfix(global::Player __instance, NetworkReader reader, bool initialState, State __state)
    {
